package ds.com.livelocation.location.activity.providers;
...
import ds.com.livelocation.location.activity.ActivityStore;
...
public class ActivityGooglePlayServicesProvider implements ActivityProvider, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, ResultCallback<Status> {
    ...
    private static final String BROADCAST_INTENT_ACTION = ds.com.livelocation.location.activity.providers.ActivityGooglePlayServicesProvider.class.getCanonicalName() + ".DETECTED_ACTIVITY";
