...
public class MultiFallbackProvider implements LocationProvider {
    ...
    /**
     * Builder class for the {@link ds.com.livelocation.location.location.providers.MultiFallbackProvider}.
     */
    public static class Builder {

        private ds.com.livelocation.location.location.providers.MultiFallbackProvider builtProvider;

        public Builder() {
            this.builtProvider = new ds.com.livelocation.location.location.providers.MultiFallbackProvider();
        }
        ...
        /**
         * Builds a {@link ds.com.livelocation.location.location.providers.MultiFallbackProvider} instance. If no providers were added to the
         * builder, the built-in Android Location Manager is used.
         */
        public ds.com.livelocation.location.location.providers.MultiFallbackProvider build() {
