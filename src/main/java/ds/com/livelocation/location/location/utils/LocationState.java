package ds.com.livelocation.location.location.utils;
...
public class LocationState {
    ...
    private static ds.com.livelocation.location.location.utils.LocationState instance;
    ...
    public static LocationState with(Context context) {
        if (instance == null) {
            instance = new ds.com.livelocation.location.location.utils.LocationState(context.getApplicationContext());
        }
        return instance;
    }
