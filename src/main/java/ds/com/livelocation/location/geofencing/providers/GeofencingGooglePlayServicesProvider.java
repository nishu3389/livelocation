package ds.com.livelocation.location.geofencing.providers;
...
import ds.com.livelocation.location.geofencing.GeofencingStore;
...
import ds.com.livelocation.location.utils.GooglePlayServicesListener;
...
public class GeofencingGooglePlayServicesProvider implements GeofencingProvider, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, ResultCallback<Status> {
    ...
    public static final String BROADCAST_INTENT_ACTION = ds.com.livelocation.location.geofencing.providers.GeofencingGooglePlayServicesProvider.class.getCanonicalName() + ".GEOFENCE_TRANSITION";
