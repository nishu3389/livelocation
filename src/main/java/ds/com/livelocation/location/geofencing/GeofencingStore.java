...
import ds.com.livelocation.location.common.Store;
...
public class GeofencingStore implements Store<GeofenceModel> {
    ...
    private static final String PREFIX_ID = ds.com.livelocation.location.geofencing.GeofencingStore.class.getCanonicalName() + ".KEY";
